...
```
Install the marketing-glossary skill from the shared repository
```

### Option 2: Manual Installation
1. Download this `SKILL.md` file
2. Create a directory in your skills folder: `~/.config/claude/skills/marketing-glossary/`
